...
class Gios_Newsletter {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Gios_Newsletter_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'gios-newsletter';
	 ...
	 *
	 * - Gios_Newsletter_Loader. Orchestrates the hooks of the plugin.
	 * - Gios_Newsletter_i18n. Defines internationalization functionality.
	 * - Gios_Newsletter_Admin. Defines all hooks for the admin area.
	 * - Gios_Newsletter_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-gios-newsletter-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-gios-newsletter-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-gios-newsletter-admin.php';
	 ...
	 *
	 * Uses the Gios_Newsletter_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Gios_Newsletter_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Gios_Newsletter_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Gios_Newsletter_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Gios_Newsletter_Loader    Orchestrates the hooks of the plugin.
	 */
